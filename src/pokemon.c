...
static const enum NationalDexOrder sKantoToNationalOrder[KANTO_DEX_COUNT] =
{
    ...
    KANTO_TO_NATIONAL(SCORBUNNY),
    KANTO_TO_NATIONAL(RABOOT),
    KANTO_TO_NATIONAL(CINDERACE),
    ...
    KANTO_TO_NATIONAL(FLETCHLING),
    KANTO_TO_NATIONAL(FLETCHINDER),
    KANTO_TO_NATIONAL(TALONFLAME),
    KANTO_TO_NATIONAL(KOMALA),
    KANTO_TO_NATIONAL(PICHU),
    KANTO_TO_NATIONAL(PIKACHU),
    KANTO_TO_NATIONAL(RAICHU),
    KANTO_TO_NATIONAL(BUNNELBY),
    KANTO_TO_NATIONAL(DIGGERSBY),
    ...
    KANTO_TO_NATIONAL(BUNEARY),
    KANTO_TO_NATIONAL(LOPUNNY),
    KANTO_TO_NATIONAL(BLITZLE),
    KANTO_TO_NATIONAL(ZEBSTRIKA),
    KANTO_TO_NATIONAL(SKIDDO),
    KANTO_TO_NATIONAL(GOGOAT),
    ...
    KANTO_TO_NATIONAL(NICKIT),
    KANTO_TO_NATIONAL(THIEVUL),
    ...
    KANTO_TO_NATIONAL(TIMBURR),
    KANTO_TO_NATIONAL(GURDURR),
    KANTO_TO_NATIONAL(CONKELDURR),
    ...
    KANTO_TO_NATIONAL(GRUBBIN),
    KANTO_TO_NATIONAL(CHARJABUG),
    KANTO_TO_NATIONAL(VIKAVOLT),
    ...
    KANTO_TO_NATIONAL(WATTREL),
    KANTO_TO_NATIONAL(KILOWATTREL),
    ...
    KANTO_TO_NATIONAL(SANDILE),
    KANTO_TO_NATIONAL(KROOKODILE),
    KANTO_TO_NATIONAL(AXEW),
    KANTO_TO_NATIONAL(FRAXURE),
    KANTO_TO_NATIONAL(HAXORUS),
    KANTO_TO_NATIONAL(TYRUNT),
    KANTO_TO_NATIONAL(TYRANTRUM),
    KANTO_TO_NATIONAL(AMAURA),
    KANTO_TO_NATIONAL(AURORUS),
    KANTO_TO_NATIONAL(ROLYCOLY),
    KANTO_TO_NATIONAL(CARKOL),
    KANTO_TO_NATIONAL(COALOSSAL),
    KANTO_TO_NATIONAL(CHARCADET),
    KANTO_TO_NATIONAL(ARMAROUGE),
    KANTO_TO_NATIONAL(CERULEDGE),
    ...
    KANTO_TO_NATIONAL(ROTOM),
    KANTO_TO_NATIONAL(FROAKIE),
    KANTO_TO_NATIONAL(FROGADIER),
    KANTO_TO_NATIONAL(GRENINJA),
    KANTO_TO_NATIONAL(EKANS),
    KANTO_TO_NATIONAL(ARBOK),
    KANTO_TO_NATIONAL(AIPOM),
    KANTO_TO_NATIONAL(AMBIPOM),
    ...
    KANTO_TO_NATIONAL(TINKATINK),
    KANTO_TO_NATIONAL(TINKATUFF),
    KANTO_TO_NATIONAL(TINKATON),
    KANTO_TO_NATIONAL(SCRAGGY),
    KANTO_TO_NATIONAL(SCRAFTY),
    ...
    KANTO_TO_NATIONAL(JOLTIK),
    KANTO_TO_NATIONAL(GALVANTULA),
    KANTO_TO_NATIONAL(GOOMY),
    KANTO_TO_NATIONAL(SLIGGOO),
    KANTO_TO_NATIONAL(GOODRA),
    ...
    KANTO_TO_NATIONAL(FIDOUGH),
    KANTO_TO_NATIONAL(DACHSBUN),
    KANTO_TO_NATIONAL(CORSOLA),
    KANTO_TO_NATIONAL(CURSOLA),
    KANTO_TO_NATIONAL(MANTYKE),
    KANTO_TO_NATIONAL(MANTINE),
    KANTO_TO_NATIONAL(LARVESTA),
    KANTO_TO_NATIONAL(VOLCARONA),
    KANTO_TO_NATIONAL(CUTIEFLY),
    KANTO_TO_NATIONAL(RIBOMBEE),
    KANTO_TO_NATIONAL(BRAMBLIN),
    KANTO_TO_NATIONAL(BRAMBLEGHAST),
    ...
    KANTO_TO_NATIONAL(YANMEGA),
    KANTO_TO_NATIONAL(CRABRAWLER),
    KANTO_TO_NATIONAL(CRABOMINABLE),
    ...
    KANTO_TO_NATIONAL(DHELMISE),
    KANTO_TO_NATIONAL(MILTANK),
    KANTO_TO_NATIONAL(LARVITAR),
    KANTO_TO_NATIONAL(PUPITAR),
    KANTO_TO_NATIONAL(TYRANITAR),
    KANTO_TO_NATIONAL(CARNIVINE),
    KANTO_TO_NATIONAL(JANGMO_O),
    KANTO_TO_NATIONAL(HAKAMO_O),
    KANTO_TO_NATIONAL(KOMMO_O),
    KANTO_TO_NATIONAL(PAWNIARD),
    KANTO_TO_NATIONAL(BISHARP),
    KANTO_TO_NATIONAL(KINGAMBIT),
    ...
    KANTO_TO_NATIONAL(ESCAVALIER),
    KANTO_TO_NATIONAL(KARRABLAST),
