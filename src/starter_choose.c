...
#define GRASS_STARTER (IS_FRLG ? SPECIES_SNIVY  : SPECIES_TREECKO)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_SCORBUNNY : SPECIES_TORCHIC)
#define WATER_STARTER (IS_FRLG ? SPECIES_TOTODILE   : SPECIES_MUDKIP )
